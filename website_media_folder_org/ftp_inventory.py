...
class FTPInventory:
    ...
    def calculate_md5(self, filepath: str) -> str:
        """
        Download file from FTP and calculate MD5 hash.
    ...
    def generate_inventory(self, start_path: str = "/", include_hashes: bool = True):
        """
...
def main():
    ...
    start_path = input("Starting directory path (default '/'): ").strip() or "/"
